...
import 'widgets/q_score_breakdown.dart';
import 'widgets/ai_verdict_card.dart';

class DecisionReportScreen extends StatelessWidget {
  const DecisionReportScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Q-Score™ Report"),
        centerTitle: true,
      ),
      body: SafeArea(
